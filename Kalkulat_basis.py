# KALKULAT_BASIS ADALAH KODE BASIS SAJA, YAITU KODE YANG BISA DIJALANKAN TETAPI TIDAK MENANGKAP ERROR
# KALKULAT_BASIS HANYA BERTUJUAN UNTUK MENAMPILKAN KODE BASIS UNTUK MELAKUKAN KOMPUTASI
# UNTUK VERSI YANG LENGKAP, ADA DI KALKULAT.PY
